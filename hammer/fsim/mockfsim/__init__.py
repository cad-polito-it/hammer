...
from hammer.vlsi import HammerFaultSimTool, DummyHammerTool, HammerToolStep, deepdict
...
class MockSim(HammerFaultSimTool, DummyHammerTool):
    ...
    def step1(self) -> bool:
        ...
        with open(sim_file, "w") as f:
            f.write(self.get_setting("fsim.inputs.level"))
            f.write("\n")
            for option in self.get_setting("fsim.inputs.options"):
                f.write(option)
                f.write("\n")
        return True
